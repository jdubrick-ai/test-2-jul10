...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/test-2-jul10](https://github.com/jdubrick-ai/test-2-jul10)

    **GitOps Repository:** [https://github.com/jdubrick-ai/test-2-jul10-gitops](https://github.com/jdubrick-ai/test-2-jul10-gitops)

# **Usage**

To access the test-2-jul10 application that was deployed using the Software Template, complete the following instructions:
